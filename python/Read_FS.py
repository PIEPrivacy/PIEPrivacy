...
################################# Parameters ##################################
#sys.argv = ["Read_FS.py", "../data/FS/", "AL"]
#sys.argv = ["Read_FS.py", "../data/FS/", "IS"]
#sys.argv = ["Read_FS.py", "../data/FS/", "NY"]
#sys.argv = ["Read_FS.py", "../data/FS/", "TK"]
#sys.argv = ["Read_FS.py", "../data/FS/", "JK"]
#sys.argv = ["Read_FS.py", "../data/FS/", "KL"]
#sys.argv = ["Read_FS.py", "../data/FS/", "SP"]
